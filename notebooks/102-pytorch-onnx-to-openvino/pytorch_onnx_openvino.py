...
# In this example, we will use LR-ASPP model with MobileNetV3 backbone.
...
# According to the input transforms function, the model is pre-trained on images with a height of 520 and width of 780.

# Taking input from console
"""
print("Write Image Width: ")
IMAGE_WIDTH = int(input()) # 780
print("Write Image Height: ")
IMAGE_HEIGHT = int(input()) # 520
"""
print("Write Directory Name of Model ... ")
print("example: model")
DIRECTORY_NAME = input()
print("Write Model Name ... ")
print("example: /lraspp_mobilenet_v3_large")
MODEL_NAME = input()
...
print("example: ../data/image/coco.jpg")
